...
-0.06, -0.26, 1.37
	...
	cfg.lsc_rgain = (U16*)malloc(sizeof(U16) * cfg.lsc_wblock * cfg.lsc_hblock);
	cfg.lsc_bgain = (U16*)malloc(sizeof(U16) * cfg.lsc_wblock * cfg.lsc_hblock);
	cfg.lsc_grgain = (U16*)malloc(sizeof(U16) * cfg.lsc_wblock * cfg.lsc_hblock);
	cfg.lsc_gbgain = (U16*)malloc(sizeof(U16) * cfg.lsc_wblock * cfg.lsc_hblock);

	memcpy(cfg.lsc_rgain, lsc_tmpr, sizeof(U16) * cfg.lsc_wblock * cfg.lsc_hblock);
	memcpy(cfg.lsc_bgain, lsc_tmpb, sizeof(U16) * cfg.lsc_wblock * cfg.lsc_hblock);
	memcpy(cfg.lsc_grgain, lsc_tmpgr, sizeof(U16) * cfg.lsc_wblock * cfg.lsc_hblock);
	memcpy(cfg.lsc_gbgain, lsc_tmpgb, sizeof(U16) * cfg.lsc_wblock * cfg.lsc_hblock);
